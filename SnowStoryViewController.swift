//
//  SnowStoryViewController.swift
//  mine_yours
//
//  Created by Frankshammer42 on 12/3/18.
...
class SnowStoryViewController: UIHeadGazeViewController, AVAudioPlayerDelegate{
...
//    }
    ...
    @IBAction func backButtonTouchUpInside(_ sender: UIHoverableButton) {
        if (video_finish_play){
            ...
            self.performSegue(withIdentifier: "snowBack", sender: self)
        }
    }
    
    
//    @objc func hide_the_fourth_button(){
...
//    var appear_sound_player: AVAudioPlayer?
    
    private func loadStorySounds(){
        do{
            if let fileURL = Bundle.main.path(forResource: "snow_1", ofType: "m4a") {
        ...
        do{
            if let fileURL = Bundle.main.path(forResource: "snow_2", ofType: "m4a") {
                print("Continue processing")
        ...
        do{
            if let fileURL = Bundle.main.path(forResource: "snow_3", ofType: "m4a") {
                print("Continue processing")
        ...
        do{
            if let fileURL = Bundle.main.path(forResource: "snow_4", ofType: "m4a") {
                print("Continue processing")
...
//            }
    ...
    private func setup_vid(){
        let fileURL = URL(fileURLWithPath: Bundle.main.path(forResource: "snow", ofType: "mov")!)
