//
//  BalconyStoryViewController.swift
//  mine_yours
//
//  Created by Frankshammer42 on 12/14/18.
...
class BalconyStoryViewController: UIHeadGazeViewController, AVAudioPlayerDelegate{
    ...
    @IBAction func backButtonTouchUpInside(_ sender: UIHoverableButton) {
        if (video_finish_play){
            ...
            self.performSegue(withIdentifier: "balconyBack", sender: self)
        }
    }
    
    private func loadStorySounds(){
        do{
            if let fileURL = Bundle.main.path(forResource: "balcony_1", ofType: "m4a") {
        ...
        do{
            if let fileURL = Bundle.main.path(forResource: "balcony_2", ofType: "m4a") {
                print("Continue processing")
        ...
        do{
            if let fileURL = Bundle.main.path(forResource: "balcony_3", ofType: "m4a") {
                print("Continue processing")
        ...
        do{
            if let fileURL = Bundle.main.path(forResource: "balcony_4", ofType: "m4a") {
                print("Continue processing")
    ...
    private func setup_vid(){
        let fileURL = URL(fileURLWithPath: Bundle.main.path(forResource: "balcony", ofType: "mov")!)
